            ...
            <div>
                ...
                >
                    ...
                    <tbody>
                        ...
                        {
                            let defults = {stuffCount:0,totalOff:0,totalPrice:0};
                        ...
                        return (
                            <tr key={Invoice.id}>
                                ...
                                <td>{Invoice.totalOff}</td>
                                <td>{Invoice.totalPrice - Invoice.totalOff}</td>
                                <td>
                                    <span title={Invoice.description} >توضیحات</span>
