...
import { InvoiceInsert } from './components/Invoice/InvoiceInsert';
    ...
    render() {
        return (
            <Layout>
                ...
                <Route path="/invoices/edit/:id" component={InvoiceUpdate} />
                <Route path="/invoices/create" component={InvoiceInsert} />
            </Layout>
        );
    }
}
